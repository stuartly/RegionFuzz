...
gnome-terminal -e "../../../afl-fuzz-org -i ../fuzz_seed -o out-AFL-Org -d ./installed-Org/bin/md5sum  -c @@"

gnome-terminal -e "../../../afl-fast-fuzz -i ../fuzz_seed -o out-AFL-Fast -d ./installed-Org/bin/md5sum -c @@"

gnome-terminal -e "../../../fairfuzz -i ../fuzz_seed -o out-Fair-Fuzz -d ./installed-Org/bin/md5sum -c @@"

gnome-terminal -e "../../../tafl-fuzz -i ../fuzz_seed -o out-TAFL-MemDensity -d -G BBMemDensity ./installed-MemDensity/bin/md5sum -c @@"

gnome-terminal -e "../../../tafl-fuzz -i ../fuzz_seed -o out-TAFL-InstNum -d -G BBInstNum ./installed-InstNum/bin/md5sum -c @@"

gnome-terminal -e "../../../tafl-fuzz -i ../fuzz_seed -o out-TAFL-Depth -d -G BBDepth ./installed-Depth/bin/md5sum -c @@"

gnome-terminal -e "../../../tafl-fuzz -i ../fuzz_seed -o out-TAFL-EntryDegree -d -G BBEntryDegree ./installed-EntryDegree/bin/md5sum -c @@"
